...
use Mia\Ad\Repository\MIAAdSectionRepository;

/**
 * Description of ListHandler
 * 
 * @OA\Post(
 *     path="/mia-ad/list-sections",
 *     summary="MiaAdSection List",
 *     tags={"MiaAdSection"},
 *     @OA\RequestBody(
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaAdSection")
 *                  )
 *              }
 *          )
 *     ),
 ...
 */
class ListSectionsHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    /**
     * 
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = MIAAdSectionRepository::fetchByConfigure($configure);
